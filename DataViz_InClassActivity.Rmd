---
title: 'Data Visualization: In Class Activity'
author: "QBS 103"
date: "July 23, 2024"
output: pdf_document
---
...
# Define age groups one way
randomData$AgeGroup <- ifelse(randomData$Age > 60,'60-70',
                              ifelse(randomData$Age > 50,'50-60',
                                     ifelse(randomData$Age > 40,'40-50',
                                            ifelse(randomData$Age > 30,'30-40','Under 30'))))
# Define age groups another way
randomData[which(randomData$Age > 60),'AgeGroup'] <- '60-70'
randomData[which(randomData$Age <= 60 & randomData$Age > 50),'AgeGroup'] <- '50-60'
randomData[which(randomData$Age <= 50 & randomData$Age > 40),'AgeGroup'] <- '50-60'
randomData[which(randomData$Age <= 40 & randomData$Age > 30),'AgeGroup'] <- '50-60'
randomData[which(randomData$Age <= 30),'AgeGroup'] <- 'Under 30'
# Define age groups a more efficient way
...
# Get comfortable googling things! To get the color palette to print backwards, I'm using the rev() function 
# If you google something to the effect of "r color palette backwards" you will likely find this as well as other solutions
...
ggplot(randomData,aes(x = Age,y = Systolic.BP,color = AgeGroup)) +
  ...
  geom_vline(xintercept = c(35,45,55,65,75),linetype = 'dashed',color = colorPalette) +
...
1. The color palette is "Royal2" from the *wesanderson* package but can you think of how you might still reproduce this without knowing that?
